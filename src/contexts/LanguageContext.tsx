...
type TranslationKeys =
  ...
  | 'articles.multitenancy.title'
  | 'articles.multitenancy.excerpt'
  | 'projects.mozonline.description'
  | 'projects.mozonline.title'
  | 'projects.meticalconverter.description'
  | 'projects.meticalconverter.title';
...
const translations: Record<Language, Partial<Record<TranslationKeys, string>>> = {
  en: {
    ...
    'projects.mozonline.description':
      'Aggregator of Mozambican public services, allows access to all from a single platform',
    'projects.meticalconverter.description':
      'Aplicattion to convert currencies from Metical to other currencies and vice versa, with public API integration for real-time exchange rates and good documentation for easy implementation.',
    ...
    'articles.internationalization.title':
      'Software Internationalization and Localization: Why it Matters and How to Implement it',
    'articles.internationalization.excerpt':
    ...
    'articles.multitenancy.title':
      'Multi-Tenant Applications: How to Develop Them and Techniques for Managing Them',
    'articles.multitenancy.excerpt':
      'In this article, we will cover the concept of multi-tenant applications, how to develop them, and techniques for managing them effectively. Bringing technical and practical aspects on the subject.',
  },
  pt: {
    // Navigation
    'nav.home': 'Início',
    ...
    'experience.fasorel.description':
      'Trabalhei como mecânico industrial. garantindo o funcionamento de equipamentos industriais nas unidades funcionais da organização, tais como: refinaria de óleo alimentar, fábrica de sabão, fábrica de garrafas, planta de enchimento, planta óleo acidos e outros.',
    'experience.merec.role': 'Operador Técnico de Produção',
    'experience.merec.period': 'Setembro 2022',
    'experience.merec.description':
      'Trabalhei como operador técnico de produção na fábrica de biscoitos. Onde garantia o pleno funcionamento de equipamentos como máquinas de embalagem, fornos, misturadores industriais e outros equipamentos. realizando manutenção periódica e correctiva.',
    ...
    'experience.cfm.description':
      'Fui estagiário de mecânica industrial nas oficinas gerais da CFM Maputo. nos departamentos de conservação oficinal e produção geral.',
    ...
    'projects.thikithi.description':
      'Aplicação para venda de Bilhetes Online de forma fácil e segura',
    ...
    'projects.mozonline.description':
      'Agregador de serviços públicos moçambicanos, permite aceder a todos a partir de uma só plataforma',
    'projects.meticalconverter.description':
      'Aplicação para converter moedas de Metical para outras moedas e vice-versa, com integração de API pública para taxas de câmbio em tempo real e boa documentação para fácil implementação.',
    ...
    'articles.validators.title':
      'Garantindo Dados Limpos: Validadores Personalizados no Spring Boot',
    'articles.validators.excerpt':
    ...
    'articles.multitenancy.title':
      'Aplicações Multi-Tenant: Como Desenvolver e Técnicas para Lidar com Elas',
    'articles.multitenancy.excerpt':
      'Neste artigo, abordo o conceito de aplicações multi-tenant, como desenvolvê-las e técnicas para gerenciá-las de forma eficaz. Trazendo aspectos técnicos e práticos sobre o tema.',
